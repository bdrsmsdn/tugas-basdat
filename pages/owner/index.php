...
$jd1 = mysqli_num_rows(mysqli_query($conn, "select * from menu"));
...
$halaman_awal = ($halaman>1) ? ($halaman * $batas) - $batas : 0;	
  ...
  $next = $halaman + 1;
	...
	$data=mysqli_query($conn,"select l.id_pembayaran, l.tanggal_laporan, l.total_pembayaran, p.status from laporan as l join pembayaran as p on l.id_pembayaran = p.id_pembayaran where p.status = 1");
