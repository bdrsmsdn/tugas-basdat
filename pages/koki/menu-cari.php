...
$dicari=$db->escape_string($_POST["cari"]);
  ...
  $next = $halaman + 1;
	...
	$data=mysqli_query($conn,"SELECT * FROM menu where nama_menu like '%$dicari%'");
$jumlah_data = mysqli_num_rows($data);
$total_halaman = ceil($jumlah_data / $batas);
$halaman_2akhir = $total_halaman - 1;
$adjacents = "2";

$data_produk = mysqli_query($conn,"SELECT * FROM menu where nama_menu like '%$dicari%' limit $halaman_awal, $batas");
       ...
       <div class="row">
                  <table class="table table-dark text-white text-center table-striped table-responsive-sm">
                    <tr>
                        <th>No</th><th>Nama menu</th><th>Stok Tersedia</th>
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <tr>
                ...
                <td><input type="number" class="form-control" id="id_menuq" name="id_menu" maxlength="15" required></td>
            </tr>
            </div>
        </div>            
    </div>
